...
title: New Patient Three Callouts Test
landingMainNav:
...
landingPageSections:
  ...
  - _component: landing-page-components/new-patient-three-callouts/split
    ...
    listItems:
      ...
      - Experienced in Maximizing Benefits
      - Accepting Nearly All Insurance Plans
    image:
  ...
  - _component: landing-page-components/new-patient-three-callouts/split
    ...
    listItems:
      ...
      - We Give You Treatment Options
      - We Start with Fair, Competitive Fees
    image:
      source: https://placehold.co/480x420
      alt: Team member smiling
    figcaption: ''
